...
public final class DDArmorMaterials {
    public static final BlueprintArmorMaterial WARDEN_CARAPACE = new BlueprintArmorMaterial((new ResourceLocation(DeeperAndDarker.MODID, "warden_carapace")), 45, new int[]{3, 6, 8, 3}, 19, () -> SoundEvents.SCULK_BLOCK_PLACE, 0F, 0F, () -> Ingredient.of(DDItems.WARDEN_CARAPACE.get()));
}