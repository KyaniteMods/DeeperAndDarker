...
public class DDBlockTagsProvider extends BlockTagsProvider {
    ...
    public void spreadingReplaceTags() {
        ...
        tag(DDTags.Blocks.SCULK_STONE_STAIRS_REPLACE).add(Blocks.STONE_BRICK_STAIRS);
        tag(DDTags.Blocks.SCULK_STONE_SLABS_REPLACE).add(Blocks.STONE_BRICK_SLAB);
        tag(DDTags.Blocks.SCULK_STONE_WALLS_REPLACE).add(Blocks.STONE_BRICK_WALL);

        tag(DDTags.Blocks.POLISHED_SCULK_STONE_SLABS_REPLACE).add(Blocks.POLISHED_DEEPSLATE_SLAB);
        tag(DDTags.Blocks.POLISHED_SCULK_STONE_STAIRS_REPLACE).add(Blocks.POLISHED_DEEPSLATE_STAIRS);
        tag(DDTags.Blocks.POLISHED_SCULK_STONE_WALLS_REPLACE).add(Blocks.POLISHED_DEEPSLATE_WALL);

        tag(DDTags.Blocks.COBBLED_SCULK_STONE_STAIRS_REPLACE).add(Blocks.COBBLESTONE_STAIRS);
        tag(DDTags.Blocks.COBBLED_SCULK_STONE_SLABS_REPLACE).add(Blocks.COBBLESTONE_SLAB);
        tag(DDTags.Blocks.COBBLED_SCULK_STONE_WALLS_REPLACE).add(Blocks.COBBLESTONE_WALL);

        tag(DDTags.Blocks.SCULK_STONE_BRICKS_STAIRS_REPLACE).add(Blocks.BRICK_STAIRS);
        tag(DDTags.Blocks.SCULK_STONE_BRICKS_SLABS_REPLACE).add(Blocks.BRICK_SLAB);
        tag(DDTags.Blocks.SCULK_STONE_BRICKS_WALLS_REPLACE).add(Blocks.BRICK_WALL);
        ...
        tag(BlockTags.SCULK_REPLACEABLE).addTags(DDTags.Blocks.SCULK_STONE_REPLACE, DDTags.Blocks.COBBLED_SCULK_STONE_REPLACE, DDTags.Blocks.POLISHED_SCULK_STONE_REPLACE, DDTags.Blocks.SCULK_STONE_BRICKS_REPLACE,
                DDTags.Blocks.SCULK_STONE_BRICKS_STAIRS_REPLACE, DDTags.Blocks.SCULK_STONE_BRICKS_SLABS_REPLACE, DDTags.Blocks.COBBLED_SCULK_STONE_SLABS_REPLACE, DDTags.Blocks.COBBLED_SCULK_STONE_STAIRS_REPLACE,
                DDTags.Blocks.POLISHED_SCULK_STONE_SLABS_REPLACE, DDTags.Blocks.POLISHED_SCULK_STONE_STAIRS_REPLACE);
    }
}