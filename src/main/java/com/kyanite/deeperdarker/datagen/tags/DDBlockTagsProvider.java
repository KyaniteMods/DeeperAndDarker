...
public class DDBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        tag(BlockTags.MINEABLE_WITH_AXE).add(DDBlocks.BONE_WALL_SIGN.get(), DDBlocks.BONE_SIGN.get()).addTag(DDTags.Blocks.BONE_WOOD);
        ...
        tag(BlockTags.MINEABLE_WITH_HOE).add(DDBlocks.SCULK_BONE_WALL_SIGN.get(), DDBlocks.SCULK_BONE_SIGN.get(), DDBlocks.SCULK_GLEAM.get(), DDBlocks.INFESTED_SCULK.get()).addTag(DDTags.Blocks.SCULK_BONE_WOOD);
        ...
        tag(BlockTags.SLABS).add(DDBlocks.SCULK_STONE_SLAB.get(), DDBlocks.POLISHED_SCULK_STONE_SLAB.get(), DDBlocks.SCULK_STONE_BRICK_SLAB.get());
        tag(BlockTags.STAIRS).add(DDBlocks.SCULK_STONE_STAIRS.get(), DDBlocks.POLISHED_SCULK_STONE_STAIRS.get(), DDBlocks.SCULK_STONE_BRICK_STAIRS.get());
        tag(BlockTags.WALLS).add(DDBlocks.SCULK_STONE_WALL.get(), DDBlocks.POLISHED_SCULK_STONE_WALL.get(), DDBlocks.SCULK_STONE_BRICK_WALL.get());
