...
public class DDItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        blockModel(DDBlocks.LAYERED_GLOOMSLATE);
        blockModel(DDBlocks.LAYERED_GLOOMSLATE_STAIRS);
        blockModel(DDBlocks.LAYERED_GLOOMSLATE_SLAB);
        blockModel(DDBlocks.LAYERED_GLOOMSLATE_WALL, "inventory");
