...
public class DDBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(DDBlocks.GLEAM_GEL_BLOCK.get(), models().cubeAll(DDBlocks.GLEAM_GEL_BLOCK.getId().getPath(), blockLoc(DDBlocks.GLEAM_GEL_BLOCK)).renderType("translucent"));
