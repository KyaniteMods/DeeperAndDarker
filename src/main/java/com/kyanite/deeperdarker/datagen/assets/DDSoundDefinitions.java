...
public class DDSoundDefinitions extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        add(DDSounds.SLUDGE_ATTACK, subtitle("entity.sludge.attack").with(mcSound("mob/slime/attack1"), mcSound("mob/slime/attack2")));
        add(DDSounds.SLUDGE_DEATH, subtitle("entity.sludge.death").with(mcSound("mob/slime/big1"), mcSound("mob/slime/big2"), mcSound("mob/slime/big3"), mcSound("mob/slime/big4")));
        add(DDSounds.SLUDGE_HURT, subtitle("entity.sludge.hurt").with(mcSound("mob/slime/big1"), mcSound("mob/slime/big2"), mcSound("mob/slime/big3"), mcSound("mob/slime/big4")));
        add(DDSounds.SLUDGE_JUMP, definition().with(mcSound("mob/slime/big1"), mcSound("mob/slime/big2"), mcSound("mob/slime/big3"), mcSound("mob/slime/big4")));
        add(DDSounds.SLUDGE_SQUISH, subtitle("entity.sludge.squish").with(mcSound("mob/slime/big1"), mcSound("mob/slime/big2"), mcSound("mob/slime/big3"), mcSound("mob/slime/big4")));
        add(DDSounds.SLUDGE_DEATH_SMALL, subtitle("entity.sludge.death").with(mcSound("mob/slime/small1"), mcSound("mob/slime/small2"), mcSound("mob/slime/small3"), mcSound("mob/slime/small4"), mcSound("mob/slime/small5")));
        add(DDSounds.SLUDGE_HURT_SMALL, subtitle("entity.sludge.hurt").with(mcSound("mob/slime/small1"), mcSound("mob/slime/small2"), mcSound("mob/slime/small3"), mcSound("mob/slime/small4"), mcSound("mob/slime/small5")));
        add(DDSounds.SLUDGE_JUMP_SMALL, definition().with(mcSound("mob/slime/small1"), mcSound("mob/slime/small2"), mcSound("mob/slime/small3"), mcSound("mob/slime/small4"), mcSound("mob/slime/small5")));
        add(DDSounds.SLUDGE_SQUISH_SMALL, subtitle("entity.sludge.squish").with(mcSound("mob/slime/small1"), mcSound("mob/slime/small2"), mcSound("mob/slime/small3"), mcSound("mob/slime/small4"), mcSound("mob/slime/small5")));
