...
public class StonecuttingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(DDBlocks.SCULK_STONE.get()), DDBlocks.POLISHED_SCULK_STONE_BRICKS.get(), 1).unlockedBy("has_sculk_stone", has(DDBlocks.SCULK_STONE.get())).save(consumer, new ResourceLocation(DeeperAndDarker.MOD_ID, "polished_sculk_stone_from_sculk_stone_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(DDBlocks.SCULK_STONE.get()), DDBlocks.POLISHED_SCULK_STONE_BRICK_SLAB.get(), 2).unlockedBy("has_sculk_stone", has(DDBlocks.SCULK_STONE.get())).save(consumer, new ResourceLocation(DeeperAndDarker.MOD_ID, "polished_sculk_stone_slab_from_sculk_stone_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(DDBlocks.SCULK_STONE.get()), DDBlocks.POLISHED_SCULK_STONE_BRICK_STAIRS.get(), 1).unlockedBy("has_sculk_stone", has(DDBlocks.SCULK_STONE.get())).save(consumer, new ResourceLocation(DeeperAndDarker.MOD_ID, "polished_sculk_stone_stairs_from_sculk_stone_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(DDBlocks.SCULK_STONE.get()), DDBlocks.POLISHED_SCULK_STONE_BRICK_WALL.get(), 1).unlockedBy("has_sculk_stone", has(DDBlocks.SCULK_STONE.get())).save(consumer, new ResourceLocation(DeeperAndDarker.MOD_ID, "polished_sculk_stone_wall_from_sculk_stone_stonecutting"));
