...
public class CraftingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        polishedBuilder(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get(), Ingredient.of(DDBlocks.POLISHED_SCULK_STONE.get())).unlockedBy("has_polished_sculk_stone", has(DDBlocks.POLISHED_SCULK_STONE.get())).save(consumer);
        slabBuilder(DDBlocks.POLISHED_SCULK_STONE_BRICK_SLAB.get(), Ingredient.of(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).unlockedBy("has_polished_sculk_stone_bricks", has(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).save(consumer);
        stairBuilder(DDBlocks.POLISHED_SCULK_STONE_BRICK_STAIRS.get(), Ingredient.of(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).unlockedBy("has_polished_sculk_stone_bricks", has(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).save(consumer);
        wallBuilder(DDBlocks.POLISHED_SCULK_STONE_BRICK_WALL.get(), Ingredient.of(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).unlockedBy("has_polished_sculk_stone_bricks", has(DDBlocks.POLISHED_SCULK_STONE_BRICKS.get())).save(consumer);
    }
