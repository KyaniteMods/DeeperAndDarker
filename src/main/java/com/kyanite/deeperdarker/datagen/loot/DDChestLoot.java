    ...
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        consumer.accept(ANCIENT_TEMPLE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(5, 10))
                        ...
                        .add(LootItem.lootTableItem(Items.DIAMOND_LEGGINGS).setWeight(2).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.5f, 0.8f))).apply(EnchantWithLevelsFunction.enchantWithLevels(UniformGenerator.between(30, 50)).allowTreasure()))
                        ...
                        .add(LootItem.lootTableItem(Items.POTION).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))).apply(SetPotionFunction.setPotion(Potions.STRONG_REGENERATION)))
                        ...
                        .add(LootItem.lootTableItem(Items.AMETHYST_SHARD).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 13))))
                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 7))))
                        ...
                        .add(LootItem.lootTableItem(Items.COMPASS).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
                        .add(LootItem.lootTableItem(Items.DISC_FRAGMENT_5).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
                        ...
                        .add(LootItem.lootTableItem(Items.GLOW_BERRIES).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 15))))
                        .add(LootItem.lootTableItem(Blocks.SCULK).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(4, 10))))
                        ...
                        .add(LootItem.lootTableItem(Blocks.SCULK_SENSOR).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
                        .add(LootItem.lootTableItem(Items.SOUL_TORCH).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 16))))
        ...
        consumer.accept(ANCIENT_TEMPLE_PORTAL, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).add(LootItem.lootTableItem(DDItems.SCULK_TRANSMITTER.get()))).withPool(LootPool.lootPool().setRolls(UniformGenerator.between(5, 10)).add(LootItem.lootTableItem(Blocks.COBWEB))));
    }
}
