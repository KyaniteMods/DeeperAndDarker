...
public class DDItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        tag(ItemTags.TRIMMABLE_ARMOR).add(DDItems.RESONARIUM_HELMET.get(), DDItems.RESONARIUM_CHESTPLATE.get(), DDItems.RESONARIUM_LEGGINGS.get(), DDItems.RESONARIUM_BOOTS.get(),
        ...
        tag(Tags.Items.ARMORS_HELMETS).add(DDItems.RESONARIUM_HELMET.get(), DDItems.WARDEN_HELMET.get());
        tag(Tags.Items.ARMORS_CHESTPLATES).add(DDItems.RESONARIUM_CHESTPLATE.get(), DDItems.WARDEN_CHESTPLATE.get());
