...
public class DDLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("warden_upgrade_from_ancient_city", new AddItemModifier(new LootItemCondition[] { LootTableIdCondition.builder(new ResourceLocation("chests/ancient_city")).build(), LootItemRandomChanceCondition.randomChance(0.45f).build()  }, DDItems.WARDEN_UPGRADE_SMITHING_TEMPLATE.get()));
    }
}
