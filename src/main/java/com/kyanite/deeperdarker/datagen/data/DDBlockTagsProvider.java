...
public class DDBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        tag(BlockTags.STONE_BRICKS).add(DDBlocks.SCULK_STONE_BRICKS.get(), DDBlocks.GLOOMSLATE_BRICKS.get(), DDBlocks.SCULK_GRIME_BRICKS.get());
        ...
        tag(DDTags.Blocks.SCULK_STONE_REPLACEABLE).add(Blocks.SCULK, DDBlocks.SCULK_GRIME.get());
