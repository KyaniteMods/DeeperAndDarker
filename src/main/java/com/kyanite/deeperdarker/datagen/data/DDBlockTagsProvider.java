...
public class DDBlockTagsProvider extends BlockTagsProvider {
    public DDBlockTagsProvider(DataGenerator generator, ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags() {
        ...
        tag(BlockTags.MINEABLE_WITH_HOE).add(DDBlocks.ECHO_LEAVES.get(), DDBlocks.GLOOMY_SCULK.get(), DDBlocks.GLOOMY_GEYSER.get(), DDBlocks.SCULK_GLEAM.get(), DDBlocks.SCULK_VINES.get(), DDBlocks.SCULK_VINES_PLANT.get(), DDBlocks.INFESTED_SCULK.get(), DDBlocks.SCULK_JAW.get());
...
//        tag(BlockTags.PORTALS).add(DDBlocks.OTHERSIDE_PORTAL.get());
        ...
        tag(DDTags.Blocks.ECHO_SOIL).add(DDBlocks.ECHO_SOIL.get(), Blocks.SCULK);
        tag(DDTags.Blocks.SCULK_STONE_TARGET).add(DDBlocks.SCULK_STONE.get(), DDBlocks.SCULK_GRIME.get());
        tag(DDTags.Blocks.GLOOMSLATE_TARGET).add(DDBlocks.GLOOMSLATE.get());
        tag(DDTags.Blocks.SCULK_GRIME_TARGET).add(DDBlocks.SCULK_GRIME.get());
