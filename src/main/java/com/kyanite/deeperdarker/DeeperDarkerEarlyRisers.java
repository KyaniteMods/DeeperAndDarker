...
public class DeeperDarkerEarlyRisers implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            ClassTinkerers.enumBuilder(instrument, "Ljava/lang/String;", "L" + holder + ";", "L" + type + ";").addEnum("DEEPERDARKER_SHATTERED", () -> new Object[]{"deeperdarker_shattered", Holder.direct(SoundEvent.createVariableRangeEvent(new ResourceLocation(DeeperDarker.MOD_ID, "block.note_block.imitate.shattered"))), obj}).build();
