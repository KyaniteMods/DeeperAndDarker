...
public class DeeperDarkerEarlyRisers implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            ClassTinkerers.enumBuilder(instrument, "Ljava/lang/String;", "L" + holder + ";", "L" + type + ";").addEnum("deeperdarker$SHATTERED", "deeperdarker_shattered", Holder.direct(SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("deeperdarker", "block.note_block.imitate.shattered"))), obj).build();
