...
public class DDEntities {
    ...
    public static final RegistryObject<EntityType<DDBoat>> BOAT = ENTITY_TYPES.register("boat", () -> EntityType.Builder.of(DDBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build(new ResourceLocation(DeeperAndDarker.MOD_ID, "boat").toString()));
    public static final RegistryObject<EntityType<DDChestBoat>> CHEST_BOAT = ENTITY_TYPES.register("chest_boat", () -> EntityType.Builder.of(DDChestBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build(new ResourceLocation(DeeperAndDarker.MOD_ID, "chest_boat").toString()));
}