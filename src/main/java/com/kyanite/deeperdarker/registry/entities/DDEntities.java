...
public class DDEntities {
    ...
    public static final RegistryObject<EntityType<SculkLeechEntity>> SCULK_LEECH = ENTITY_TYPES.register("sculk_leech", () -> EntityType.Builder.of(SculkLeechEntity::new, MobCategory.MONSTER).sized(0.3f, 0.3f).build(new ResourceLocation(DeeperAndDarker.MOD_ID, "sculk_leech").toString()));
}
