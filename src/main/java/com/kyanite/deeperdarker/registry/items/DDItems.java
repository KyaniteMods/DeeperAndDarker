...
public class DDItems {
 ...
 //   public static final RegistryObject<Item> BLOOM_BERRIES = ITEMS.register("bloom_berries", () -> new Item(new Item.Properties().food(Foods.GLOW_BERRIES).tab(DDCreativeModeTab.DD_TAB)));
    ...
    public static final RegistryObject<SpawnEggItem> CENTIPEDE_SPAWN_EGG = ITEMS.register("sculk_centipede_spawn_egg", () -> new ForgeSpawnEggItem(DDEntities.CENTIPEDE, 0x172226 , 0x6abdd9, (new Item.Properties()).tab(DDCreativeModeTab.DD_TAB)));
