...
public class DDConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> BLOB_SCULK = CONFIGURED_FEATURES.register("blob_sculk", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(SCULK_TARGET_LIST.get(), 64)));
