...
public class DDPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> PLACE_SCULK_GLEAM = PLACED_FEATURES.register("sculk_gleam_placed", () -> new PlacedFeature(DDConfiguredFeatures.SCULK_GLEAM.getHolder().get(), List.of(CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome())));
}