...
public class DDPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> SCULK_STONE_PLACED = PLACED_FEATURES.register("sculk_stone_placed",
            () -> new PlacedFeature(DDConfiguredFeatures.SCULK_STONE.getHolder().get(),
                    DDPlacementUtils.commonOrePlacement(32,
