...
public class DDPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> SCULK_IRON_ORE = PLACED_FEATURES.register("sculk_iron_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_IRON_SCULK.getHolder().get(), commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(24), VerticalAnchor.aboveBottom(128)))));
    public static final RegistryObject<PlacedFeature> SCULK_COPPER_ORE = PLACED_FEATURES.register("sculk_copper_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_COPPER_SCULK.getHolder().get(), commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(24), VerticalAnchor.aboveBottom(256)))));
    public static final RegistryObject<PlacedFeature> SCULK_GOLD_ORE = PLACED_FEATURES.register("sculk_gold_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_GOLD_SCULK.getHolder().get(), commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-70), VerticalAnchor.aboveBottom(70)))));
    public static final RegistryObject<PlacedFeature> SCULK_REDSTONE_ORE = PLACED_FEATURES.register("sculk_redstone_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_REDSTONE_SCULK.getHolder().get(), commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(64)))));
    public static final RegistryObject<PlacedFeature> SCULK_EMERALD_ORE = PLACED_FEATURES.register("sculk_emerald_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_EMERALD_SCULK.getHolder().get(), commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-16), VerticalAnchor.aboveBottom(30)))));
    ...
    public static final RegistryObject<PlacedFeature> SCULK_DIAMOND_ORE = PLACED_FEATURES.register("sculk_diamond_ore", () -> new PlacedFeature(DDConfiguredFeatures.ORE_DIAMOND_SCULK.getHolder().get(), commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(50)))));
    ...
    public static final RegistryObject<PlacedFeature> OTHERSIDE_PILLAR = PLACED_FEATURES.register("otherside_pillar", () -> new PlacedFeature(DDConfiguredFeatures.OTHERSIDE_PILLAR.getHolder().get(), commonOrePlacement(75, PlacementUtils.FULL_RANGE)));
