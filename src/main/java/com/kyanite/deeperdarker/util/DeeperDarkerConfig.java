...
public class DeeperDarkerConfig {
    ...
    private static final ModConfigSpec.IntValue SOUL_ELYTRA_COOLDOWN = BUILDER.comment("Soul Elytra's boost cooldown in ticks", "Default: 600").defineInRange("soulElytraCooldown", 600, 0, 12000);
