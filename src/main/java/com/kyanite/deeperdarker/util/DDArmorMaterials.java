...
public class DDArmorMaterials extends ArmorMaterials {
    ...
    private static final EnumMap<ArmorItem.Type, Integer> SOUL_DEFENSE = Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> SOUL_ELYTRA = ARMOR_MATERIALS.register("soul_elytra", () -> new ArmorMaterial(
            WARDEN_DEFENSE, 9, SoundEvents.ARMOR_EQUIP_ELYTRA, () -> Ingredient.of(DDItems.SOUL_CRYSTAL.get()), List.of(new ArmorMaterial.Layer(new ResourceLocation(DeeperDarker.MOD_ID, "soul_elytra"))), 0, 0)
    );
