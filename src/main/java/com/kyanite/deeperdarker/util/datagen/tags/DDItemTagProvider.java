...
public class DDItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        add(DDTags.Items.DAMPENS_VIBRATIONS, DDItems.WARDEN_BOOTS, DDItems.GUARDIAN_BOOTS);
        ...
        add(ItemTags.TRIMMABLE_ARMOR,
                DDItems.WARDEN_HELMET, DDItems.WARDEN_CHESTPLATE, DDItems.WARDEN_LEGGINGS, DDItems.WARDEN_BOOTS,
                DDItems.RESONARIUM_HELMET, DDItems.RESONARIUM_CHESTPLATE, DDItems.RESONARIUM_LEGGINGS, DDItems.RESONARIUM_BOOTS,
                DDItems.LEAD_HELMET, DDItems.LEAD_CHESTPLATE, DDItems.LEAD_LEGGINGS, DDItems.LEAD_BOOTS,
                DDItems.RADIOACTIVE_HELMET, DDItems.RADIOACTIVE_CHESTPLATE, DDItems.RADIOACTIVE_LEGGINGS, DDItems.RADIOACTIVE_BOOTS,
                DDItems.GUARDIAN_HELMET, DDItems.GUARDIAN_CHESTPLATE, DDItems.GUARDIAN_LEGGINGS, DDItems.GUARDIAN_BOOTS
        );
