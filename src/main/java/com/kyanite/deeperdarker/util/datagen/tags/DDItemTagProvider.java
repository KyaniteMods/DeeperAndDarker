...
public class DDItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        add(ItemTags.HEAD_ARMOR, DDItems.WARDEN_HELMET, DDItems.RESONARIUM_HELMET);
        add(ItemTags.CHEST_ARMOR, DDItems.WARDEN_CHESTPLATE, DDItems.RESONARIUM_CHESTPLATE);
        add(ItemTags.LEG_ARMOR, DDItems.WARDEN_LEGGINGS, DDItems.RESONARIUM_LEGGINGS);
        add(ItemTags.FOOT_ARMOR, DDItems.WARDEN_BOOTS, DDItems.RESONARIUM_BOOTS);
        ...
        getOrCreateTagBuilder(DDTags.Items.SCUTES).add(Items.ARMADILLO_SCUTE, Items.TURTLE_SCUTE);

        add(ConventionalItemTags.BERRIES_FOODS, DDItems.BLOOM_BERRIES);
        add(ConventionalItemTags.STONES, DDBlocks.GLOOMSLATE, DDBlocks.SCULK_STONE);
        add(ConventionalItemTags.COBBLESTONES, DDBlocks.COBBLED_GLOOMSLATE, DDBlocks.COBBLED_SCULK_STONE);
