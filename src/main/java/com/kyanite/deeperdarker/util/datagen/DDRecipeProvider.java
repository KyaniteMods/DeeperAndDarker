...
public class DDRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        NETHERITE_HELMET_TO_WARDEN_HELMET_UPGRADE.save(exporter, DeeperDarker.id("netherite_helmet_to_warden_helmet_upgrade"));
        NETHERITE_CHESTPLATE_TO_WARDEN_CHESTPLATE_UPGRADE.save(exporter, DeeperDarker.id("netherite_chestplate_to_warden_chestplate_upgrade"));
        NETHERITE_LEGGINGS_TO_WARDEN_LEGGINGS_UPGRADE.save(exporter, DeeperDarker.id("netherite_leggings_to_warden_leggings_upgrade"));
        NETHERITE_BOOTS_TO_WARDEN_BOOTS_UPGRADE.save(exporter, DeeperDarker.id("netherite_boots_to_warden_boots_upgrade"));
        NETHERITE_SWORD_TO_WARDEN_SWORD_UPGRADE.save(exporter, DeeperDarker.id("netherite_sword_to_warden_sword_upgrade"));
        NETHERITE_PICKAXE_TO_WARDEN_PICKAXE_UPGRADE.save(exporter, DeeperDarker.id("netherite_pickaxe_to_warden_pickaxe_upgrade"));
        NETHERITE_AXE_TO_WARDEN_AXE_UPGRADE.save(exporter, DeeperDarker.id("netherite_axe_to_warden_axe_upgrade"));
        NETHERITE_SHOVEL_TO_WARDEN_SHOVEL_UPGRADE.save(exporter, DeeperDarker.id("netherite_shovel_to_warden_shovel_upgrade"));
        NETHERITE_HOE_TO_WARDEN_HOE_UPGRADE.save(exporter, DeeperDarker.id("netherite_hoe_to_warden_hoe_upgrade"));
        IRON_HELMET_TO_RESONARIUM_HELMET_UPGRADE.save(exporter, DeeperDarker.id("iron_helmet_to_resonarium_helmet_upgrade"));
        IRON_CHESTPLATE_TO_RESONARIUM_CHESTPLATE_UPGRADE.save(exporter, DeeperDarker.id("iron_chestplate_to_resonarium_chestplate_upgrade"));
        IRON_LEGGINGS_TO_RESONARIUM_LEGGINGS_UPGRADE.save(exporter, DeeperDarker.id("iron_leggings_to_resonarium_leggings_upgrade"));
        IRON_BOOTS_TO_RESONARIUM_BOOTS_UPGRADE.save(exporter, DeeperDarker.id("iron_boots_to_resonarium_boots_upgrade"));
        IRON_SWORD_TO_RESONARIUM_SWORD_UPGRADE.save(exporter, DeeperDarker.id("iron_sword_to_resonarium_sword_upgrade"));
        IRON_PICKAXE_TO_RESONARIUM_PICKAXE_UPGRADE.save(exporter, DeeperDarker.id("iron_pickaxe_to_resonarium_pickaxe_upgrade"));
        IRON_AXE_TO_RESONARIUM_AXE_UPGRADE.save(exporter, DeeperDarker.id("iron_axe_to_resonarium_axe_upgrade"));
        IRON_SHOVEL_TO_RESONARIUM_SHOVEL_UPGRADE.save(exporter, DeeperDarker.id("iron_shovel_to_resonarium_shovel_upgrade"));
        IRON_HOE_TO_RESONARIUM_HOE_UPGRADE.save(exporter, DeeperDarker.id("iron_hoe_to_resonarium_hoe_upgrade"));
