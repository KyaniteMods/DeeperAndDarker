...
public class DDRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        SmithingTransformRecipeBuilder NETHERITE_HOE_TO_WARDEN_HOE_UPGRADE = SmithingTransformRecipeBuilder.smithing(
                ...
                RecipeCategory.COMBAT,
                DDItems.WARDEN_HOE);
        SmithingTransformRecipeBuilder FLINT_AND_STEEL_TO_WARDEN_FLINT_AND_STEEL_DOWNGRADE = SmithingTransformRecipeBuilder.smithing(
                Ingredient.of(new ItemStack(DDItems.WARDEN_UPGRADE_SMITHING_TEMPLATE)),
                Ingredient.of(new ItemStack(Items.FLINT_AND_STEEL)),
                Ingredient.of(new ItemStack(DDItems.REINFORCED_ECHO_SHARD)),
                RecipeCategory.TOOLS,
                DDItems.WARDEN_FLINT_AND_STEEL);
        ...
        FLINT_AND_STEEL_TO_WARDEN_FLINT_AND_STEEL_DOWNGRADE.unlocks(FabricRecipeProvider.getHasName(DDItems.WARDEN_UPGRADE_SMITHING_TEMPLATE), FabricRecipeProvider.has(DDItems.WARDEN_UPGRADE_SMITHING_TEMPLATE));
        ...
        FLINT_AND_STEEL_TO_WARDEN_FLINT_AND_STEEL_DOWNGRADE.save(exporter, new ResourceLocation(DeeperDarker.MOD_ID, "flint_and_steel_to_warden_flint_and_steel_downgrade"));
    ...
    private static void aprilFoolsRecipes(RecipeOutput exporter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DDBlocks.ECHO_LOG_PYRAMID).define('L', DDBlocks.ECHO_LOG).pattern(" L ").pattern("LLL").unlockedBy(FabricRecipeProvider.getHasName(DDBlocks.ECHO_LOG), FabricRecipeProvider.has(DDBlocks.ECHO_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DDBlocks.ECHO_WOOD_PYRAMID).define('W', DDBlocks.ECHO_WOOD).pattern(" W ").pattern("WWW").unlockedBy(FabricRecipeProvider.getHasName(DDBlocks.ECHO_WOOD), FabricRecipeProvider.has(DDBlocks.ECHO_WOOD)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DDBlocks.STRIPPED_ECHO_LOG_PYRAMID).define('L', DDBlocks.STRIPPED_ECHO_LOG).pattern(" L ").pattern("LLL").unlockedBy(FabricRecipeProvider.getHasName(DDBlocks.STRIPPED_ECHO_LOG), FabricRecipeProvider.has(DDBlocks.STRIPPED_ECHO_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DDBlocks.STRIPPED_ECHO_WOOD_PYRAMID).define('W', DDBlocks.STRIPPED_ECHO_WOOD).pattern(" W ").pattern("WWW").unlockedBy(FabricRecipeProvider.getHasName(DDBlocks.STRIPPED_ECHO_WOOD), FabricRecipeProvider.has(DDBlocks.STRIPPED_ECHO_WOOD)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DDBlocks.BIOSCULK_LOG_PYRAMID).define('L', DDBlocks.BIOSCULK_LOG).pattern(" L ").pattern("LLL").unlockedBy(FabricRecipeProvider.getHasName(DDBlocks.BIOSCULK_LOG), FabricRecipeProvider.has(DDBlocks.BIOSCULK_LOG)).save(exporter);
