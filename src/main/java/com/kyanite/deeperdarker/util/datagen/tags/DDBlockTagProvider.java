...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        getOrCreateTagBuilder(BlockTags.LOGS_THAT_BURN).addTag(DDTags.Blocks.ECHO_LOGS).addTag(DDTags.Blocks.BIOSCULK_LOGS);
        getOrCreateTagBuilder(BlockTags.PLANKS).add(DDBlocks.ECHO_PLANKS, DDBlocks.BIOSCULK_PLANKS);
        getOrCreateTagBuilder(BlockTags.WOODEN_STAIRS).add(DDBlocks.ECHO_STAIRS, DDBlocks.BIOSCULK_STAIRS);
        getOrCreateTagBuilder(BlockTags.WOODEN_SLABS).add(DDBlocks.ECHO_SLAB, DDBlocks.BIOSCULK_SLAB);
        getOrCreateTagBuilder(BlockTags.WOODEN_FENCES).add(DDBlocks.ECHO_FENCE, DDBlocks.BIOSCULK_FENCE);
        getOrCreateTagBuilder(BlockTags.FENCE_GATES).add(DDBlocks.ECHO_FENCE_GATE, DDBlocks.BIOSCULK_FENCE_GATE);
        getOrCreateTagBuilder(BlockTags.WOODEN_DOORS).add(DDBlocks.ECHO_DOOR, DDBlocks.BIOSCULK_DOOR);
        getOrCreateTagBuilder(BlockTags.WOODEN_TRAPDOORS).add(DDBlocks.ECHO_TRAPDOOR, DDBlocks.BIOSCULK_TRAPDOOR);
        getOrCreateTagBuilder(BlockTags.WOODEN_PRESSURE_PLATES).add(DDBlocks.ECHO_PRESSURE_PLATE, DDBlocks.BIOSCULK_PRESSURE_PLATE);
        getOrCreateTagBuilder(BlockTags.WOODEN_BUTTONS).add(DDBlocks.ECHO_BUTTON, DDBlocks.BIOSCULK_BUTTON);
        getOrCreateTagBuilder(BlockTags.LEAVES).add(DDBlocks.ECHO_LEAVES, DDBlocks.BIOSCULK_LEAVES);
        getOrCreateTagBuilder(BlockTags.SAPLINGS).add(DDBlocks.ECHO_SAPLING);
        getOrCreateTagBuilder(BlockTags.STANDING_SIGNS).add(DDBlocks.ECHO_SIGN, DDBlocks.BIOSCULK_SIGN);
        getOrCreateTagBuilder(BlockTags.WALL_SIGNS).add(DDBlocks.ECHO_WALL_SIGN, DDBlocks.BIOSCULK_WALL_SIGN);
        getOrCreateTagBuilder(BlockTags.CEILING_HANGING_SIGNS).add(DDBlocks.ECHO_HANGING_SIGN, DDBlocks.BIOSCULK_HANGING_SIGN);
        getOrCreateTagBuilder(BlockTags.WALL_HANGING_SIGNS).add(DDBlocks.ECHO_WALL_HANGING_SIGN, DDBlocks.BIOSCULK_WALL_HANGING_SIGN);
        ...
        getOrCreateTagBuilder(DDTags.Blocks.BIOSCULK_LOGS).add(DDBlocks.BIOSCULK_LOG, DDBlocks.BIOSCULK_WOOD, DDBlocks.STRIPPED_BIOSCULK_LOG, DDBlocks.STRIPPED_BIOSCULK_WOOD);
        getOrCreateTagBuilder(DDTags.Blocks.ECHO_PYRAMIDS).add(DDBlocks.ECHO_LOG_PYRAMID, DDBlocks.ECHO_WOOD_PYRAMID, DDBlocks.STRIPPED_ECHO_LOG_PYRAMID, DDBlocks.STRIPPED_ECHO_WOOD_PYRAMID);
        getOrCreateTagBuilder(DDTags.Blocks.BIOSCULK_PYRAMIDS).add(DDBlocks.BIOSCULK_LOG_PYRAMID, DDBlocks.BIOSCULK_WOOD_PYRAMID, DDBlocks.STRIPPED_BIOSCULK_LOG_PYRAMID, DDBlocks.STRIPPED_BIOSCULK_WOOD_PYRAMID);
