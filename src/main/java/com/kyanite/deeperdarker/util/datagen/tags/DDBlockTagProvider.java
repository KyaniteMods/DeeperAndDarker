...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        tagBuilder(BlockTags.PIGLIN_REPELLENTS).add(DDBlocks.SCULK_FIRE, DDBlocks.SCULK_TORCH, DDBlocks.SCULK_WALL_TORCH, DDBlocks.SCULK_CAMPFIRE, DDBlocks.SCULK_LANTERN);
        ...
        tagBuilder(BlockTags.FIRE).add(DDBlocks.SCULK_FIRE);
