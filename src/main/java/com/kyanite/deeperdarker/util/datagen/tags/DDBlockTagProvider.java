...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        add(BlockTags.MINEABLE_WITH_AXE, DDBlocks.ECHO_PLANKS, DDBlocks.ECHO_STAIRS, DDBlocks.ECHO_SLAB, DDBlocks.ECHO_FENCE, DDBlocks.ECHO_FENCE_GATE, DDBlocks.ECHO_DOOR, DDBlocks.ECHO_TRAPDOOR, DDBlocks.ECHO_PRESSURE_PLATE, DDBlocks.ECHO_BUTTON,
                ...
                DDBlocks.GLOWING_GRASS, DDBlocks.GLOOMY_GRASS, DDBlocks.ICE_LILY).addTag(DDTags.Blocks.ECHO_LOGS).addTag(DDTags.Blocks.BLOOMING_STEMS);
        add(BlockTags.MINEABLE_WITH_HOE, DDBlocks.ECHO_LEAVES, DDBlocks.GLOOMY_SCULK, DDBlocks.GLOOMY_GEYSER, DDBlocks.SCULK_GLEAM, DDBlocks.POROUS_SCULK_GLEAM, DDBlocks.GLOWING_FLOWERS, DDBlocks.SCULK_VINES, DDBlocks.SCULK_VINES_PLANT, DDBlocks.GLOWING_ROOTS, DDBlocks.GLOWING_ROOTS_PLANT, DDBlocks.GLOWING_VINES, DDBlocks.GLOWING_VINES_PLANT, DDBlocks.INFESTED_SCULK, DDBlocks.SCULK_JAW);
        add(BlockTags.MINEABLE_WITH_PICKAXE, DDBlocks.SCULK_STONE, DDBlocks.COBBLED_SCULK_STONE, DDBlocks.POLISHED_SCULK_STONE, DDBlocks.SCULK_STONE_BRICKS, DDBlocks.SCULK_STONE_TILES, DDBlocks.SMOOTH_SCULK_STONE, DDBlocks.CUT_SCULK_STONE, DDBlocks.CHISELED_SCULK_STONE,
                ...
                DDBlocks.GLOOMSLATE, DDBlocks.COBBLED_GLOOMSLATE, DDBlocks.POLISHED_GLOOMSLATE, DDBlocks.GLOOMSLATE_BRICKS, DDBlocks.GLOOMSLATE_TILES, DDBlocks.SMOOTH_GLOOMSLATE, DDBlocks.CUT_GLOOMSLATE, DDBlocks.CHISELED_GLOOMSLATE, DDBlocks.GLOOMSLATE_LIGHT,
        ...
        add(BlockTags.LOGS_THAT_BURN).addTag(DDTags.Blocks.ECHO_LOGS);
        ...
        add(BlockTags.INSIDE_STEP_SOUND_BLOCKS, DDBlocks.GLOWING_FLOWERS, DDBlocks.ICE_LILY);
        ...
        add(DDTags.Blocks.GLOOMSLATE_REPLACEABLE, DDBlocks.GLOOMY_SCULK, DDBlocks.GLOOMY_GEYSER);
        add(DDTags.Blocks.GLOOMY_SCULK_REPLACEABLE, Blocks.SCULK, DDBlocks.SCULK_STONE, DDBlocks.GLOOMSLATE, DDBlocks.SCULK_GRIME, DDBlocks.ECHO_SOIL, DDBlocks.GLOOMY_SCULK);
        add(DDTags.Blocks.BLOOMING_POOL_REPLACEABLE, DDBlocks.BLOOMING_SCULK_STONE, DDBlocks.BLOOMING_MOSS_BLOCK);
        add(DDTags.Blocks.SCULK_VINE_PLACEABLE, Blocks.SCULK, DDBlocks.SCULK_STONE, DDBlocks.ECHO_LEAVES);
