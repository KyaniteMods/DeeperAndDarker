...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        tagBuilder(BlockTags.MINEABLE_WITH_PICKAXE).add(DDBlocks.SCULK_STONE, DDBlocks.COBBLED_SCULK_STONE, DDBlocks.POLISHED_SCULK_STONE, DDBlocks.SCULK_STONE_BRICKS, DDBlocks.SCULK_STONE_TILES, DDBlocks.SMOOTH_SCULK_STONE, DDBlocks.CUT_SCULK_STONE, DDBlocks.CHISELED_SCULK_STONE, DDBlocks.SCULK_TISSUE_BRICKS,
                DDBlocks.SCULK_STONE_STAIRS, DDBlocks.COBBLED_SCULK_STONE_STAIRS, DDBlocks.POLISHED_SCULK_STONE_STAIRS, DDBlocks.SCULK_STONE_BRICK_STAIRS, DDBlocks.SCULK_STONE_TILE_STAIRS, DDBlocks.SMOOTH_SCULK_STONE_STAIRS, DDBlocks.CUT_SCULK_STONE_STAIRS, DDBlocks.SCULK_TISSUE_BRICK_STAIRS,
                DDBlocks.SCULK_STONE_SLAB, DDBlocks.COBBLED_SCULK_STONE_SLAB, DDBlocks.POLISHED_SCULK_STONE_SLAB, DDBlocks.SCULK_STONE_BRICK_SLAB, DDBlocks.SCULK_STONE_TILE_SLAB, DDBlocks.SMOOTH_SCULK_STONE_SLAB, DDBlocks.CUT_SCULK_STONE_SLAB, DDBlocks.SCULK_TISSUE_BRICK_SLAB,
                DDBlocks.SCULK_STONE_WALL, DDBlocks.COBBLED_SCULK_STONE_WALL, DDBlocks.POLISHED_SCULK_STONE_WALL, DDBlocks.SCULK_STONE_BRICK_WALL, DDBlocks.SCULK_STONE_TILE_WALL, DDBlocks.SMOOTH_SCULK_STONE_WALL, DDBlocks.CUT_SCULK_STONE_WALL, DDBlocks.SCULK_TISSUE_BRICK_WALL,
                DDBlocks.SCULK_PERMAFROST, DDBlocks.SNOWY_SCULK_PERMAFROST, DDBlocks.BLOOMING_SCULK_STONE, DDBlocks.BLOOMING_MOSS_BLOCK,
                ...
                DDBlocks.GLOOMSLATE_WALL, DDBlocks.COBBLED_GLOOMSLATE_WALL, DDBlocks.POLISHED_GLOOMSLATE_WALL, DDBlocks.GLOOMSLATE_BRICK_WALL, DDBlocks.GLOOMSLATE_TILE_WALL, DDBlocks.SMOOTH_GLOOMSLATE_WALL, DDBlocks.CUT_GLOOMSLATE_WALL, DDBlocks.FORTIFIED_CUT_GLOOMSLATE,
                DDBlocks.SCULK_GRIME_BRICKS, DDBlocks.SCULK_GRIME_BRICK_STAIRS, DDBlocks.SCULK_GRIME_BRICK_SLAB, DDBlocks.SCULK_GRIME_BRICK_WALL, DDBlocks.FORTIFIED_SCULK_GRIME_BRICKS,
                DDBlocks.SCULK_STONE_COAL_ORE, DDBlocks.SCULK_STONE_IRON_ORE, DDBlocks.SCULK_STONE_COPPER_ORE, DDBlocks.SCULK_STONE_GOLD_ORE, DDBlocks.SCULK_STONE_REDSTONE_ORE, DDBlocks.SCULK_STONE_EMERALD_ORE, DDBlocks.SCULK_STONE_LAPIS_ORE, DDBlocks.SCULK_STONE_DIAMOND_ORE, DDBlocks.SCULK_STONE_LEAD_ORE,
                DDBlocks.RAW_LEAD_BLOCK, DDBlocks.LEAD_BLOCK, DDBlocks.FIZZ_BLOCK, DDBlocks.RADIOACTIVE_BLOCK, DDBlocks.SCULK_BASALT,
                DDBlocks.RED_CRYSTAL_BLOCK, DDBlocks.GREEN_CRYSTAL_BLOCK, DDBlocks.BLUE_CRYSTAL_BLOCK,
                ...
                DDBlocks.CRYSTALLIZED_AMBER, DDBlocks.ANCIENT_VASE, DDBlocks.FRAGILE_SCULK_GRIME_BRICKS, DDBlocks.FRAGILE_GLOOMSLATE_BRICKS, DDBlocks.GLOOMSLATE_LOCK, DDBlocks.SCULK_GRIME_LOCK, DDBlocks.SCULK_LANTERN,
                DDBlocks.DEAD_MANS_CHEST, DDBlocks.SCULK_ALTAR).addOptional(reverseLookup(DDCreateCompat.Blocks.WARDEN_BACKTANK));
        tagBuilder(BlockTags.WALL_POST_OVERRIDE).add(DDBlocks.SCULK_TORCH);
        tagBuilder(BlockTags.PIGLIN_REPELLENTS).add(DDBlocks.SCULK_FIRE, DDBlocks.SCULK_TORCH, DDBlocks.SCULK_WALL_TORCH, DDBlocks.SCULK_CAMPFIRE, DDBlocks.SCULK_LANTERN, DDBlocks.PATIENCE_SOUL_FIRE, DDBlocks.FORTITUDE_SOUL_FIRE, DDBlocks.CORRUPTION_SOUL_FIRE, DDBlocks.PURITY_SOUL_FIRE, DDBlocks.VIRTUE_SOUL_FIRE);
        tagBuilder(BlockTags.MINEABLE_WITH_SHOVEL).add(DDBlocks.ECHO_SOIL, DDBlocks.ECHO_FARMLAND, DDBlocks.SCULK_GRIME);
        tagBuilder(BlockTags.NEEDS_STONE_TOOL).add(DDBlocks.SCULK_STONE_IRON_ORE, DDBlocks.SCULK_STONE_COPPER_ORE, DDBlocks.SCULK_STONE_LAPIS_ORE, DDBlocks.GLOOMSLATE_IRON_ORE, DDBlocks.GLOOMSLATE_COPPER_ORE, DDBlocks.GLOOMSLATE_LAPIS_ORE, DDBlocks.RAW_LEAD_BLOCK, DDBlocks.LEAD_BLOCK, DDBlocks.RADIOACTIVE_BLOCK, DDBlocks.CRYSTALLIZED_AMBER);
        ...
        tagBuilder(BlockTags.SWORD_EFFICIENT).add(DDBlocks.GLOWING_GRASS, DDBlocks.GLOWING_FLOWERS, DDBlocks.GLOOMY_GRASS, DDBlocks.ICE_LILY, DDBlocks.SCULK_TUBERS, DDBlocks.SCULK_TISSUE, DDBlocks.SCULK_FERN, DDBlocks.LARGE_SCULK_FERN, DDBlocks.DARK_FOUNTAIN);
        tagBuilder(BlockTags.FIRE).add(DDBlocks.SCULK_FIRE, DDBlocks.PATIENCE_SOUL_FIRE, DDBlocks.FORTITUDE_SOUL_FIRE, DDBlocks.CORRUPTION_SOUL_FIRE, DDBlocks.PURITY_SOUL_FIRE, DDBlocks.VIRTUE_SOUL_FIRE);
        tagBuilder(BlockTags.CAMPFIRES).add(DDBlocks.SCULK_CAMPFIRE);
        ...
        tagBuilder(BlockTags.STAIRS).add(DDBlocks.SCULK_STONE_STAIRS, DDBlocks.COBBLED_SCULK_STONE_STAIRS, DDBlocks.POLISHED_SCULK_STONE_STAIRS, DDBlocks.SCULK_STONE_BRICK_STAIRS, DDBlocks.SCULK_STONE_TILE_STAIRS, DDBlocks.SMOOTH_SCULK_STONE_STAIRS, DDBlocks.CUT_SCULK_STONE_STAIRS, DDBlocks.SCULK_GRIME_BRICK_STAIRS,
                DDBlocks.GLOOMSLATE_STAIRS, DDBlocks.COBBLED_GLOOMSLATE_STAIRS, DDBlocks.POLISHED_GLOOMSLATE_STAIRS, DDBlocks.GLOOMSLATE_BRICK_STAIRS, DDBlocks.GLOOMSLATE_TILE_STAIRS, DDBlocks.SMOOTH_GLOOMSLATE_STAIRS, DDBlocks.CUT_GLOOMSLATE_STAIRS, DDBlocks.SCULK_TISSUE_BRICK_STAIRS);
        tagBuilder(BlockTags.SLABS).add(DDBlocks.SCULK_STONE_SLAB, DDBlocks.COBBLED_SCULK_STONE_SLAB, DDBlocks.POLISHED_SCULK_STONE_SLAB, DDBlocks.SCULK_STONE_BRICK_SLAB, DDBlocks.SCULK_STONE_TILE_SLAB, DDBlocks.SMOOTH_SCULK_STONE_SLAB, DDBlocks.CUT_SCULK_STONE_SLAB, DDBlocks.SCULK_GRIME_BRICK_SLAB,
                DDBlocks.GLOOMSLATE_SLAB, DDBlocks.COBBLED_GLOOMSLATE_SLAB, DDBlocks.POLISHED_GLOOMSLATE_SLAB, DDBlocks.GLOOMSLATE_BRICK_SLAB, DDBlocks.GLOOMSLATE_TILE_SLAB, DDBlocks.SMOOTH_GLOOMSLATE_SLAB, DDBlocks.CUT_GLOOMSLATE_SLAB, DDBlocks.SCULK_TISSUE_BRICK_SLAB);
        tagBuilder(BlockTags.WALLS).add(DDBlocks.SCULK_STONE_WALL, DDBlocks.COBBLED_SCULK_STONE_WALL, DDBlocks.POLISHED_SCULK_STONE_WALL, DDBlocks.SCULK_STONE_BRICK_WALL, DDBlocks.SCULK_STONE_TILE_WALL, DDBlocks.SMOOTH_SCULK_STONE_WALL, DDBlocks.CUT_SCULK_STONE_WALL, DDBlocks.SCULK_GRIME_BRICK_WALL,
                DDBlocks.GLOOMSLATE_WALL, DDBlocks.COBBLED_GLOOMSLATE_WALL, DDBlocks.POLISHED_GLOOMSLATE_WALL, DDBlocks.GLOOMSLATE_BRICK_WALL, DDBlocks.GLOOMSLATE_TILE_WALL, DDBlocks.SMOOTH_GLOOMSLATE_WALL, DDBlocks.CUT_GLOOMSLATE_WALL, DDBlocks.SCULK_TISSUE_BRICK_WALL);
        ...
        tagBuilder(DDTags.Blocks.GLOOMY_SCULK_REPLACEABLE).add(Blocks.SCULK, DDBlocks.SCULK_STONE, DDBlocks.GLOOMSLATE, DDBlocks.SCULK_GRIME, DDBlocks.ECHO_SOIL, DDBlocks.ECHO_FARMLAND, DDBlocks.GLOOMY_SCULK);
        ...
        tagBuilder(DDTags.Blocks.SCULK_SPRUCE_FOREST_REPLACEABLE).add(Blocks.SCULK, DDBlocks.SCULK_STONE, DDBlocks.SCULK_PERMAFROST, DDBlocks.SNOWY_SCULK_PERMAFROST, Blocks.SNOW, Blocks.GRAVEL, Blocks.DEEPSLATE);
        tagBuilder(DDTags.Blocks.ICE_REPLACEABLE).add(Blocks.SCULK, DDBlocks.SCULK_STONE, DDBlocks.SCULK_PERMAFROST, DDBlocks.SNOWY_SCULK_PERMAFROST, Blocks.DEEPSLATE);
        ...
        tagBuilder(DDTags.Blocks.SCULK_LIGHT_SOURCES).add(
                ...
                DDBlocks.SCULK_LAMP,
                DDBlocks.FORTIFIED_SCULK_GRIME_BRICKS,
                ...
                DDBlocks.FORTIFIED_CUT_GLOOMSLATE
        );
        ...
        tagBuilder(ConventionalBlockTags.ORES).add(DDBlocks.SCULK_STONE_LEAD_ORE);
        tagBuilder(ConventionalBlockTags.CHESTS).add(DDBlocks.DEAD_MANS_CHEST);
    }
}