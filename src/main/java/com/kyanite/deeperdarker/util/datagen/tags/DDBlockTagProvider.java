...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        tagBuilder(BlockTags.MINEABLE_WITH_PICKAXE).add(DDBlocks.SCULK_STONE, DDBlocks.COBBLED_SCULK_STONE, DDBlocks.POLISHED_SCULK_STONE, DDBlocks.SCULK_STONE_BRICKS, DDBlocks.SCULK_STONE_TILES, DDBlocks.SMOOTH_SCULK_STONE, DDBlocks.CUT_SCULK_STONE, DDBlocks.CHISELED_SCULK_STONE, DDBlocks.SCULK_TISSUE_BRICKS,
                ...
                DDBlocks.RAW_LEAD_BLOCK, DDBlocks.LEAD_BLOCK, DDBlocks.FIZZ_BLOCK,
        ...
        tagBuilder(BlockTags.NEEDS_STONE_TOOL).add(DDBlocks.SCULK_STONE_IRON_ORE, DDBlocks.SCULK_STONE_COPPER_ORE, DDBlocks.SCULK_STONE_LAPIS_ORE, DDBlocks.GLOOMSLATE_IRON_ORE, DDBlocks.GLOOMSLATE_COPPER_ORE, DDBlocks.GLOOMSLATE_LAPIS_ORE, DDBlocks.RAW_LEAD_BLOCK, DDBlocks.LEAD_BLOCK, DDBlocks.CRYSTALLIZED_AMBER);
        ...
        tagBuilder(BlockTags.BEACON_BASE_BLOCKS).add(DDBlocks.LEAD_BLOCK);
