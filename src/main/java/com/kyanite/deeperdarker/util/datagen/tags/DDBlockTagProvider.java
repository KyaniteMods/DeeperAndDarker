...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        add(ConventionalBlockTags.COBBLESTONES, DDBlocks.COBBLED_GLOOMSLATE, DDBlocks.COBBLED_SCULK_STONE);
        add(ConventionalBlockTags.SKULLS, DDBlocks.SHATTERED_HEAD, DDBlocks.SHATTERED_WALL_HEAD);
    }
}