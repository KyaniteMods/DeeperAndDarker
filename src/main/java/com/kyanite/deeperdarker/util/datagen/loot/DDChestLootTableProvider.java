    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        ...
        consumer.accept(BLOOMAZE_BASIC, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(4, 6))
                        ...
                        .add(LootItem.lootTableItem(DDItems.SCULK_BERRY_SPROUT)
                                .setWeight(2))
        ...
        consumer.accept(CASTLE_ROYAL, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(6, 9))
                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(18)
