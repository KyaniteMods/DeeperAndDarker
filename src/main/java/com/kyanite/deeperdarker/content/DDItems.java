...
public class DDItems {
    ...
    public static final RegistryObject<Item> STALKER_WORM_SPAWN_EGG = ITEMS.register("stalker_worm_spawn_egg", () -> new ForgeSpawnEggItem(DDEntities.STALKER, 0x172226, 0x6abdd9, new Item.Properties()));
}
