...
//                if (Floater.this.getTarget() == null) {
                    Vec3 vec32 = Floater.this.getDeltaMovement();
                    Floater.this.setYRot(-((float) Mth.atan2(vec32.x, vec32.z)) * 57.295776f);
//                } else {
//                    double e = Floater.this.getTarget().getX() - Floater.this.getX();
//                    double f = Floater.this.getTarget().getZ() - Floater.this.getZ();
//                    Floater.this.setYRot(-((float)Mth.atan2(e, f)) * 57.295776f);
//                }
