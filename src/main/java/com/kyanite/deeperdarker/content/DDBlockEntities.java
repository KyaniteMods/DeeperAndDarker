...
public class DDBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<GloomslatePotBlockEntity>> GLOOMSLATE_POT = BLOCK_ENTITIES.register("gloomslate_pot", () -> BlockEntityType.Builder.of(GloomslatePotBlockEntity::new, DDBlocks.GLOOMSLATE_POT.get()).build(null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SculkJawBlockEntity>> SCULK_JAW = BLOCK_ENTITIES.register("sculk_jaw", () -> BlockEntityType.Builder.of(SculkJawBlockEntity::new, DDBlocks.SCULK_JAW.get()).build(null));
}
