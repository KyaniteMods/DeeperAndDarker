...
public class DDEntities {
    ...
    public static final RegistryObject<EntityType<AnglerFish>> ANGLER_FISH = ENTITIES.register("angler_fish", () -> EntityType.Builder.of(AnglerFish::new, MobCategory.WATER_CREATURE).sized(0.7f, 0.4f).clientTrackingRange(10).build(new ResourceLocation(DeeperDarker.MOD_ID, "angler_fish").toString()));
