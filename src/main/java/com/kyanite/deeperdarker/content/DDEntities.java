...
public class DDEntities {
    ...
    public static final EntityType<OverseerCrystal> OVERSEER_CRYSTAL = register("overseer_crystal", FabricEntityTypeBuilder.create(MobCategory.MISC, OverseerCrystal::new).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).trackRangeChunks(10).build());
