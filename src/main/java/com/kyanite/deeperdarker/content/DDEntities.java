...
public class DDEntities {
    ...
    public static final RegistryObject<EntityType<SculkLeech>> SCULK_LEECH = ENTITIES.register("sculk_leech", () -> EntityType.Builder.of(SculkLeech::new, MobCategory.MONSTER).sized(0.3f, 0.2f).clientTrackingRange(10).build(new ResourceLocation(DeeperDarker.MOD_ID, "sculk_leech").toString()));
