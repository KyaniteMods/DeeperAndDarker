...
public class DDEntities {
    ...
    public static final EntityType<OverseerCrystalProjectile> OVERSEER_CRYSTAL_PROJECTILE = register("overseer_crystal_projectile", FabricEntityTypeBuilder.<OverseerCrystalProjectile>create(MobCategory.MISC, OverseerCrystalProjectile::new).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).trackRangeChunks(10).build());
    ...
    public static final EntityType<Overcaster> OVERCASTER = register("overcaster", FabricEntityTypeBuilder.create(MobCategory.MONSTER, Overcaster::new).dimensions(EntityDimensions.fixed(0.6f, 1.95f)).trackRangeChunks(10).build());
    ...
    private static void registerAttributes() {
        ...
        DefaultAttributeRegistryAccessor.getRegistry().put(OVERCASTER, Overcaster.createOvercasterAttributes());
    }
