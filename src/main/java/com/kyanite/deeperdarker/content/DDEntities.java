...
public class DDEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<OvercastPot>> ANGER_POT = ENTITIES.register("anger_pot", () -> EntityType.Builder.of(OvercastPot::new, MobCategory.MONSTER).sized(1.25f, 0.9375f).eyeHeight(0.4f).clientTrackingRange(10).build(DeeperDarker.rl("anger_pot").toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<OvercastPot>> FEAR_POT = ENTITIES.register("fear_pot", () -> EntityType.Builder.of(OvercastPot::new, MobCategory.MONSTER).sized(0.75f, 1.9375f).eyeHeight(1.375f).clientTrackingRange(10).build(DeeperDarker.rl("fear_pot").toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<OvercastPot>> SORROW_POT = ENTITIES.register("sorrow_pot", () -> EntityType.Builder.of(OvercastPot::new, MobCategory.MONSTER).sized(0.75f, 1.2f).eyeHeight(0.8f).clientTrackingRange(10).build(DeeperDarker.rl("sorrow_pot").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Shattered>> SHATTERED = ENTITIES.register("shattered", () -> EntityType.Builder.of(Shattered::new, MobCategory.MONSTER).sized(0.7f, 2.0625f).clientTrackingRange(10).build(DeeperDarker.rl("shattered").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Sludge>> SLUDGE = ENTITIES.register("sludge", () -> EntityType.Builder.of(Sludge::new, MobCategory.MONSTER).sized(0.52f, 0.52f).eyeHeight(0.325f).spawnDimensionsScale(4f).clientTrackingRange(10).build(DeeperDarker.rl("sludge").toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<Stalker>> STALKER = ENTITIES.register("stalker", () -> EntityType.Builder.of(Stalker::new, MobCategory.MONSTER).sized(0.9f, 4.3375f).eyeHeight(3.99f).clientTrackingRange(10).build(DeeperDarker.rl("shriek_worm").toString()));
}
