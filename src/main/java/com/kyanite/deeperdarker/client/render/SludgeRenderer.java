...
public class SludgeRenderer extends MobRenderer<Sludge, SludgeModel> {
    public static final ModelLayerLocation MODEL = new ModelLayerLocation(DeeperDarker.rl("sludge_layer"), "main");
    ...
    public SludgeRenderer(EntityRendererProvider.Context context) {
        super(context, new SludgeModel(context.bakeLayer(MODEL)), 0.25f);
