...
public class FloaterRenderer<T extends Floater> extends MobRenderer<T, EntityModel<T>> {
    private static final ResourceLocation TEXTURE = DeeperDarker.id("textures/entity/floater/floater.png");
    private static final ResourceLocation SPECIAL_TEXTURE = DeeperDarker.id("textures/entity/floater/special_floater.png");
