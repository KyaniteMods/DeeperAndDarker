...
public class ShatteredRenderer extends GeoEntityRenderer<ShatteredEntity> {
    ...
    @Override
    public RenderType getRenderType(ShatteredEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
