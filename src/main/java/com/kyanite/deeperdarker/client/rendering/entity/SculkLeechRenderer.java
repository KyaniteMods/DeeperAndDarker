...
public class SculkLeechRenderer extends GeoEntityRenderer<SculkLeechEntity> {
    ...
    @Override
    public RenderType getRenderType(SculkLeechEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
