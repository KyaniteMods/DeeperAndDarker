...
public class DDPools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> context) {
        ...
        context.register(createKey("ancient_temple/basement/rooms"), new StructureTemplatePool(empty, ImmutableList.of(Pair.of(location("ancient_temple/basement/rooms/portal_0", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/portal_1", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/throne_room", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_0", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_1", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_2", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_3", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_4", degradation), 1)), StructureTemplatePool.Projection.RIGID));
