...
public class DDPools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> context) {
        ...
        context.register(createKey("ancient_temple/basement/aisles"), new StructureTemplatePool(pool, ImmutableList.of(Pair.of(location("ancient_temple/basement/aisles/aisle_0", degradation), 1)), StructureTemplatePool.Projection.RIGID));
        ...
        context.register(createKey("ancient_temple/basement/portal"), new StructureTemplatePool(pool, ImmutableList.of(Pair.of(location("ancient_temple/basement/portal/portal_room", degradation), 1)), StructureTemplatePool.Projection.RIGID));
        context.register(createKey("ancient_temple/basement/rooms"), new StructureTemplatePool(pool, ImmutableList.of(Pair.of(location("ancient_temple/basement/rooms/room_0", degradation), 1), Pair.of(location("ancient_temple/basement/rooms/room_1", degradation), 1)), StructureTemplatePool.Projection.RIGID));
        context.register(createKey("ancient_temple/basement/stairs"), new StructureTemplatePool(pool, ImmutableList.of(Pair.of(location("ancient_temple/basement/stairs/staircase_0", degradation), 1)), StructureTemplatePool.Projection.RIGID));
        context.register(createKey("ancient_temple/basement/throne"), new StructureTemplatePool(pool, ImmutableList.of(Pair.of(location("ancient_temple/basement/throne/throne_room", degradation), 1)), StructureTemplatePool.Projection.RIGID));
