...
public class IcicleFeatureConfiguration implements FeatureConfiguration {
    public static final Codec<IcicleFeatureConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BlockStateProvider.CODEC.fieldOf("ice_state_provider").orElse(new WeightedStateProvider(
            ...
            BlockStateProvider.CODEC.fieldOf("icicle_state_provider").orElse(BlockStateProvider.simple(DDBlocks.ICICLE)).forGetter(config -> config.icicleProvider),
    ...
    ).apply(instance, IcicleFeatureConfiguration::new));
    ...
    public IcicleFeatureConfiguration(TagKey<Block> replaceable, TagKey<Block> base, BlockStateProvider iceProvider, BlockStateProvider icicleProvider, IntProvider heightProvider, float chanceOfDirectionalSpread, float chanceOfSpreadRadius2, float chanceOfSpreadRadius3) {
