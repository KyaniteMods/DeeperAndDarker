...
public class ConeConfiguration implements FeatureConfiguration {
    public static final Codec<ConeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, ConeConfiguration::new));
    ...
    public ConeConfiguration(TagKey<Block> replaceable, BlockStateProvider blockStateProvider, IntProvider widthProvider, IntProvider depthProvider, IntProvider heightProvider, IntProvider tipXShiftProvider, IntProvider yShiftProvider, IntProvider tipZShiftProvider) {
