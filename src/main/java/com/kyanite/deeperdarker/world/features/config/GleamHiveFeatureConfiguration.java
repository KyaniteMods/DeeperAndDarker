...
public record GleamHiveFeatureConfiguration(BlockStateProvider fillingProvider, BlockStateProvider outerProvider, BlockStateProvider alternateOuterProvider, IntProvider mainRadiusProvider, IntProvider secondaryRadiusProvider) implements FeatureConfiguration {
