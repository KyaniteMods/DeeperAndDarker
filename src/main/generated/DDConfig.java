...
public class DDConfig extends ConfigWrapper<com.kyanite.deeperdarker.util.DDConfigModel> {
    ...
    private final Option<java.lang.Integer> server_sonorousStaffRange = this.optionForKey(this.keys.server_sonorousStaffRange);
    ...
    private final Option<java.lang.Integer> server_snapperDropLimit = this.optionForKey(this.keys.server_snapperDropLimit);
    private final Option<java.lang.Boolean> server_createCompatibility = this.optionForKey(this.keys.server_createCompatibility);
    private final Option<java.lang.Boolean> server_showMeYourSkinCompatibility = this.optionForKey(this.keys.server_showMeYourSkinCompatibility);
    private final Option<java.lang.Boolean> server_addWardenDrops = this.optionForKey(this.keys.server_addWardenDrops);
    private final Option<java.lang.Boolean> server_addAncientCityLoot = this.optionForKey(this.keys.server_addAncientCityLoot);
    private final Option<java.lang.Boolean> server_cancelDummyBlockEntityWarning = this.optionForKey(this.keys.server_cancelDummyBlockEntityWarning);
    ...
    private final Option<java.lang.Boolean> client_whiteFog = this.optionForKey(this.keys.client_whiteFog);
    private final Option<java.lang.Integer> client_sculkTransmitterLinkCooldownSeconds = this.optionForKey(this.keys.client_sculkTransmitterLinkCooldownSeconds);
    ...
    public class Server_ implements Server {
        ...
        public int sonorousStaffRange() {
            return server_sonorousStaffRange.value();
        }

        public void sonorousStaffRange(int value) {
            server_sonorousStaffRange.set(value);
        }
        ...
        public int snapperDropLimit() {
            return server_snapperDropLimit.value();
        }

        public void snapperDropLimit(int value) {
            server_snapperDropLimit.set(value);
        }

        public boolean createCompatibility() {
            return server_createCompatibility.value();
        }

        public void createCompatibility(boolean value) {
            server_createCompatibility.set(value);
        }

        public boolean showMeYourSkinCompatibility() {
            return server_showMeYourSkinCompatibility.value();
        }

        public void showMeYourSkinCompatibility(boolean value) {
            server_showMeYourSkinCompatibility.set(value);
        }

        public boolean addWardenDrops() {
            return server_addWardenDrops.value();
        }

        public void addWardenDrops(boolean value) {
            server_addWardenDrops.set(value);
        }

        public boolean addAncientCityLoot() {
            return server_addAncientCityLoot.value();
        }

        public void addAncientCityLoot(boolean value) {
            server_addAncientCityLoot.set(value);
        }

        public boolean cancelDummyBlockEntityWarning() {
            return server_cancelDummyBlockEntityWarning.value();
        }

        public void cancelDummyBlockEntityWarning(boolean value) {
            server_cancelDummyBlockEntityWarning.set(value);
        }
    ...
    public class Client_ implements Client {
        ...
        public boolean whiteFog() {
            return client_whiteFog.value();
        }

        public void whiteFog(boolean value) {
            client_whiteFog.set(value);
        }

        public int sculkTransmitterLinkCooldownSeconds() {
            return client_sculkTransmitterLinkCooldownSeconds.value();
        }

        public void sculkTransmitterLinkCooldownSeconds(int value) {
            client_sculkTransmitterLinkCooldownSeconds.set(value);
        }
    ...
    public interface Server {
        ...
        int sonorousStaffRange();
        void sonorousStaffRange(int value);
        ...
        void snapperDropLimit(int value);
        boolean createCompatibility();
        void createCompatibility(boolean value);
        boolean showMeYourSkinCompatibility();
        void showMeYourSkinCompatibility(boolean value);
        boolean addWardenDrops();
        void addWardenDrops(boolean value);
        boolean addAncientCityLoot();
        void addAncientCityLoot(boolean value);
        boolean cancelDummyBlockEntityWarning();
        void cancelDummyBlockEntityWarning(boolean value);
    }
    public interface Client {
        ...
        boolean whiteFog();
        void whiteFog(boolean value);
        int sculkTransmitterLinkCooldownSeconds();
        void sculkTransmitterLinkCooldownSeconds(int value);
    }
    public static class Keys {
        ...
        public final Option.Key server_sonorousStaffRange = new Option.Key("server.sonorousStaffRange");
        ...
        public final Option.Key server_createCompatibility = new Option.Key("server.createCompatibility");
        public final Option.Key server_showMeYourSkinCompatibility = new Option.Key("server.showMeYourSkinCompatibility");
        public final Option.Key server_addWardenDrops = new Option.Key("server.addWardenDrops");
        public final Option.Key server_addAncientCityLoot = new Option.Key("server.addAncientCityLoot");
        public final Option.Key server_cancelDummyBlockEntityWarning = new Option.Key("server.cancelDummyBlockEntityWarning");
        ...
        public final Option.Key client_whiteFog = new Option.Key("client.whiteFog");
        public final Option.Key client_sculkTransmitterLinkCooldownSeconds = new Option.Key("client.sculkTransmitterLinkCooldownSeconds");
    }
}
