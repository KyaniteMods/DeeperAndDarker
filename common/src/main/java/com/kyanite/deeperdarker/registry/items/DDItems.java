...
public class DDItems {
  ...
  //  public static final Supplier<Item> ANCIENT_CHEST = registerItem("ancient_chest", () -> new AncientChestItem(DDBlocks.ANCIENT_CHEST.get(), new Item.Properties().tab(DDCreativeModeTab.DD_TAB).stacksTo(1)));
    ...
    public static final Supplier<DDBoatItem> ECHO_BOAT = registerBoatItem("echo_boat", () -> new DDBoatItem(false, DDBoat.Type.ECHO, new Item.Properties().tab(DDCreativeModeTab.DD_TAB).rarity(Rarity.EPIC).fireResistant().stacksTo(1)));
    public static final Supplier<DDBoatItem> ECHO_CHEST_BOAT = registerItem("echo_chest_boat", () -> new DDBoatItem(true, DDBoat.Type.ECHO, new Item.Properties().tab(DDCreativeModeTab.DD_TAB).rarity(Rarity.EPIC).fireResistant().stacksTo(1)));
