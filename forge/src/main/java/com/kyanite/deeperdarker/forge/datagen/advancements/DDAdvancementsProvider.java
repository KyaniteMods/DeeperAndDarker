...
public class DDAdvancementsProvider extends AdvancementProvider {
    ...
    protected void registerAdvancements(@NotNull Consumer<Advancement> consumer, @NotNull ExistingFileHelper fileHelper) {
        ...
        Advancement enterOtherside = Advancement.Builder.advancement().parent(killWarden).display(DDItems.HEART_OF_THE_DEEP,
        ...
        Advancement.Builder.advancement().parent(enterOtherside).display(DDItems.SCULK_TRANSMITTER,
